...
write_provenance_sidecar(
  ...
  notes = "Raster generated by terra::rasterize() of MUPOLYGON at 10 m resolution in EPSG:5070. The official NRCS MapunitRaster_10m was not used because the GDAL 3.8.4 OpenFileGDB driver in this environment does not expose FileGDB raster layers. The generated raster is functionally equivalent for analysis purposes — the cell values are the same mukeys placed on the same 10 m grid — but is not bitwise-identical to the NRCS raster. Decision recorded 2026-05-14."
)
